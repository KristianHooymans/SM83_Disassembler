...
std::string romName(std::vector<uint8_t> hexDump) {
  ...
  for (auto i {0x134}; i <= 0x143; ++i) {
    if (hexDump[i] != 0x00 && hexDump[i] !=  0x80 && hexDump[i] != 0xC0){
